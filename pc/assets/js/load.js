...
function nav_top()
{
	...
	topHtml += "	<a class='navbar-brand' href='index.html'><i class='fa fa-comments'></i> <strong>HOME </strong></a>";
	topHtml += "</div>";
	...
	topHtml += "			<li><a href='about-me.html'><i class='fa fa-user fa-fw'></i> About Author</a>";
	topHtml += "			</li>";
	topHtml += "		</ul>";
	topHtml += "	</li>";
	topHtml += "</ul>";
...
function nav_left()
{
	...
	leftHtml += "				<li><a href='experience.html'>总览</a></li>";
	leftHtml += "				<li><a href='about-me.html'>简说自己</a></li>";
	leftHtml += "				<li><a href='start-linux.html'>Linux开始</a></li>";
	leftHtml += "				<li><a href='start-github.html'>从Github开始</a></li>";
	leftHtml += "			</ul>";
	leftHtml += "		</li>";
	leftHtml += "		<li>";
